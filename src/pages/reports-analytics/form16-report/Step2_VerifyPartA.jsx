...
const Step2_VerifyPartA = ({ onVerified }) => {
    ...
    return (
        <div className="space-y-6">
            <h3 className="font-semibold text-lg">Step 2: Verify Part A Details</h3>
            <p className="text-sm text-base-content/70">Please review the data extracted from the uploaded Part A file. Ensure all details are correct before proceeding.</p>
...
export default Step2_VerifyPartA;
