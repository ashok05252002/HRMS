...
const Step1_VerifyData = ({ onVerified }) => {
    ...
    return (
        <div className="space-y-6">
            <h3 className="font-semibold text-lg">Step 1: Review & Confirm Merged Form 16 Data</h3>
            <p className="text-sm text-base-content/70">Please review the combined Part A and Part B data sourced from the system. Ensure all details are correct before proceeding to the digital signature step.</p>
...
export default Step1_VerifyData;
